...
\subsection{Architektúra backendu}
...
\subsubsection{Integrácia AI modulov}
...
\subsubsection{Práca s databázou a dátový model}
...
v entitno-relačnom diagrame databázy (obr. \ref{fig:er_diagram}), ktorý ilustruje štruktúru dátového
modelu a väzby medzi jeho jednotlivými časťami.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.35\textwidth]{er_diagram.png}
    \caption{Entitno-relačný diagram databázy}
    \label{fig:er_diagram}
\end{figure}


\subsubsection{API rozhranie}
...
% Zdroje pre backend sú v hlavnom bibliography súbore
