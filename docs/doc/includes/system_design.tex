...
\subsubsection{Správa používateľského profilu a dokumentov}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{usecase2.png}
    \caption{Use case diagram -- správa používateľského profilu a dokumentov}
    \label{fig:usecase2}
\end{figure}

\subsubsection{Spracovanie dokumentov}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{usecase1.png}
    \caption{Use case diagram -- spracovanie dokumentov}
    \label{fig:usecase1}
\end{figure}

\subsection{Tok dát v systéme}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{dataflow.png}
    \caption{Diagram toku dát v systéme}
    \label{fig:dataflow}
\end{figure}

\subsection{Sekvenčný diagram spracovania dokumentu}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{sequence1.png}
    \caption{Sekvenčný diagram spracovania dokumentu}
    \label{fig:sequence1}
\end{figure}
