...
\centerline{\includegraphics[width=1\textwidth]{img/usecase2.png}\label{fig:usecase2}}
...
\centerline{\includegraphics[width=1\textwidth]{img/usecase1.png}\label{fig:usecase1}}
...
\centerline{\includegraphics[width=0.7\textwidth]{img/dataflow.png}\label{fig:dataflow}}
...
\centerline{\includegraphics[width=0.7\textwidth]{img/sequence1.png}\label{fig:sequence1}}
